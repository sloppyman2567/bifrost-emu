// graphics.cpp — Graphics backend implementation (stub for 1.3.0-beta.2).
//
// In 1.3.0-beta.2, the framebuffer is just a chunk of memory that the
...
void GraphicsBackend::refresh() {
    // Stub: no rendering in 1.3.0-beta.2.
    // In 1.3.0, this will:
