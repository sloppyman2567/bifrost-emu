...
//
// v1.4.5-alpha: renamed from `GraphicsBackend` to
...
//
// v1.4.5-alpha: EXPERIMENTAL graphic API thunking. The
...
//
// v1.4.5-alpha: SMARTER SDL2 INIT + INPUT EVENTS.
...
class GraphicThunk;
// Forward-declare AudioThunk and DisplayThunk (v1.5.0.alpha).
class AudioThunk;
class DisplayThunk;
...
public:
    ...
    // ── EXPERIMENTAL: Graphic API thunking (v1.4.5-alpha) ──
    //
    ...
    GraphicThunk* thunk();
    // ── EXPERIMENTAL: Audio API thunking (v1.5.0.alpha) ─────────────
    ...
    // ── EXPERIMENTAL: Display API thunking (v1.5.0.alpha) ───────────
    ...
    DisplayThunk* display_thunk();
    // ── Input events (v1.4.5-alpha) ──────────────────────
    ...
    FrostInput* input();
    // ── Window management (v1.4.5-alpha) ─────────────────
...
private:
    ...
    // v1.5.0.alpha: AudioThunk and DisplayThunk instances.
