...
INTEGRATION_TESTS=(
    ...
    # vDSO fast-path regression (v1.5.1-alpha): clock_gettime /
    ...
    "simd_shift|ctest_real/test_simd_shift.elf||10|ALL PASS"
...
REALWORLD_TESTS=(
    ...
    "rw_busybox_whoami|ctest_real/realworld/busybox-aarch64 whoami||5|^$(whoami)$"
    ...
    "rw_toybox_whoami|ctest_real/toybox whoami||5|^$(whoami)$"
