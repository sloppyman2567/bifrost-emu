...
//
// 1.5.3-alpha: extracted from GraphicThunk to avoid duplication now
...
struct ThunkSymbolEntry {
    ...
    // 1.5.3-alpha: bitmask indicating which args (0-7) are
...
// 1.5.3-alpha: added id_base parameter so each thunk type
