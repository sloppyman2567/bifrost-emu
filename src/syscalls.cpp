...
void Emulator::syscall(CPU& cpu) {
    ...
    switch (num) {
        ...
        // ── Additional syscalls for broader compatibility ──────────────
        ...
        case 50: { // chdir(path) — AArch64 50
            std::string path = map_guest_path(read_path(mem_, a0));
        ...
        case 88: { // utimensat(dirfd, path, times, flags) — AArch64 88
            std::string path = a1 ? map_guest_path(read_path(mem_, a1)) : std::string();
        ...
        case 39: { // symlink(old, new) — AArch64 39
            std::string oldp = map_guest_path(read_path(mem_, a0));
            std::string newp = map_guest_path(read_path(mem_, a1));
